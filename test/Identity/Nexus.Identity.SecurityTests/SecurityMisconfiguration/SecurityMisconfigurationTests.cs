...
public class SecurityMisconfigurationTests
{
    ...
    {
        var programFile = Path.Combine(TestPathHelper.RepoRoot(), "src", "API", "Api", "Program.cs");
    ...
    {
        var appSettingsFile = Path.Combine(TestPathHelper.RepoRoot(), "src", "API", "Api", "appsettings.json");
